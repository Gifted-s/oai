...
import {  faHome, faUpload ,faWindowClose,faLink,faClock,faListAlt, faThermometer, faPen, faTasks, faMailBulk, faSms, faUsers} from '@fortawesome/free-solid-svg-icons'
 ...
 class Sidebar extends Component {
    render() {
        ...
        className={present=== "home" ? ` cr  sidebar_item`: 'sidebar_item' }>
             ...
             <span > <FontAwesomeIcon icon={faUpload}  className={present=== "home" ? `cr cr_icon`:"sidebar_text" }/></span>  <span className="sidebar_text">Upload Materials</span>
       ...
       <div onClick={()=>{
          ...
          <span> <FontAwesomeIcon className={present=== "links" ? `cr cr_icon`:"sidebar_text" } icon={faUsers} /></span> <span className="sidebar_text">View Users</span>
