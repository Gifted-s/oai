...
<body>
   <div class="cntainer" style="padding: 50px 30px; text-align: center;">
       ...
       <p>Please note that the admin would have to provide authorization before you can login</p>

       <a href="https://oneafricainitiative.netlify.app/signup"><button class="btn btn-success" style=" font-size: 14px; color: white;font-weight: 600;">
         Back to login
       </button>
    </a>
   </div>
